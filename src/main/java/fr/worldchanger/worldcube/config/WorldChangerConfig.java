...
public class WorldChangerConfig {
    ...
    public void setTimer(long timer) { config.set("timer", timer); }
    ...
    public long getTimer() { return config.getLong("timer"); }
    public int[] getCenter() {
        return new int[]{ config.getInt("center.x"), config.getInt("center.y") };
    }
